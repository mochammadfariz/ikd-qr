                        ...
                        <div class="card-body p-lg-17">
                            ...
                            <div class="mb-18">
                                ...
                                <div class="mb-11">
                                    ...
                                    <div class="mb-18">
                                        <!--begin::Title-->
                                        <h3 class="fs-2hx text-dark mb-6 text-center">Menu Teller</h3>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <form data-kt-search-element="form"
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="search" value="" placeholder="Cari Menu Teller"
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                ...
                                                <div class="card card-flush mb-10">
                                                    <!--begin::Card header-->
                                                    <div class="card-header pt-9 mx-auto center_ic_menu">
                                                        <div class="d-flex flex-column">
                                                            <div class="p-2 mr-5"><img
                                                                    src="assets/media/icons/bankdki/menuteller/setortunai.svg">
                                                            </div>
                                                        </div>
                                                        <!--begin::Author-->
                                                        <div class="d-flex align-items-center ml-5">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-flex flex-row">
                                                                    <img src="assets/media/icons/bankdki/ceklis.svg"
                                                                        class="mr-3">
                                                    ...
                                                    <div class="card-body mx-auto">
                                                        <!--begin::Post content-->
                                                        <a href="/pilih-cabang" class="btn btn-danger text-light">Pilih
                                                            Transaksi</a>
                                                        <!--end::Post content-->
                                                    </div>
                                                    <!--end::Card body-->
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                ...
                                                <div class="card card-flush mb-10">
                                                    ...
                                                    <div class="card-header pt-9 mx-auto center_ic_menu">
                                                        <div class="d-flex flex-column">
                                                            <div class="p-2 mr-5"><img
                                                                    src="assets/media/icons/bankdki/menuteller/tariktunai.svg">
                                                            </div>
                                                        </div>
                                                        <!--begin::Author-->
                                                        <div class="d-flex align-items-center ml-5">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                                                ...
                                                <div class="card card-flush mb-10">
                                                    ...
                                                    <div class="card-header pt-9 mx-auto center_ic_menu">
                                                        <div class="d-flex flex-column">
                                                            <div class="p-2 mr-5"><img
                                                                    src="assets/media/icons/bankdki/menuteller/setorandeposito.svg">
                                                            </div>
                                                        </div>
                                                        <!--begin::Author-->
                                                        <div class="d-flex align-items-center ml-5">
