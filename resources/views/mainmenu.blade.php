                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="../../demo2/dist/landing.html">
                                    <img alt="Logo" src="assets/images/bank_dki_white.svg"
                            ...
                            <div class="w-100 flex-lg-row-fluid mx-lg-13">
                                        ...
                                        <div class="card-header pt-9">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fs-4 fw-bold">Reservasi
                                                        Teller</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                                                    <span class="fw-semibold d-block"><img
                                                            src="assets/media/icons/thirdparty/time.svg" class=""
                                                            alt="" /> 08.00 - 14.00</span>
                                                    <!--end::Date-->
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                            <!--end::Author-->
                                            <!--begin::Card toolbar-->
                                            <button class="btn btn-danger"> Reservasi </button>
                                            <!--end::Card toolbar-->
                                        </div>
                                        <!--end::Card header-->
                                        <!--begin::Card body-->
                                ...
                                <div class="d-none" id="kt_social_feeds_new_post">
                                    ...
                                    <div class="card card-flush mb-10">
                                        ...
                                        <div class="card-header pt-9">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <!--begin::Name-->
                                                    <a href="#"
                                                        class="text-gray-800 text-hover-primary fs-4 fw-bold">Jerry
                                                        Kane</a>
                                                    <!--end::Name-->
                                                    <!--begin::Date-->
                                        ...
                                        <div class="card-body">
                                            <!--begin::Post content-->
                                            <div class="fs-6 fw-normal text-gray-700" data-kt-post-element="content">You
                                                can either decide on your final headline before outstanding you write
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <!--begin::Title-->
                                        <a href="../../demo2/dist/apps/projects/project.html"
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="../../demo2/dist/apps/projects/project.html" class="w-30px me-3"
                ...
                <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="nav-group nav-group-outline mx-auto" data-kt-buttons="true">
                            <button class="btn btn-color-gray-400 btn-active btn-active-secondary px-6 py-3 me-2 active">Monthly</button>
