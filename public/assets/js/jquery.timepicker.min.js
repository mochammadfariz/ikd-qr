        ...
        p = (function () {
            function n(e) {
                ...
                t(this, n),
                    ...
                    (this.targetEl = e);
                var r = n.extractAttrOptions(e, Object.keys(m));
                this.settings = this.parseSettings(s(s(s({}, m), i), r));
            }
            var r, a, u;
            return (
                (r = n),
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (this.selectedValue != e) {
                                ...
                                var r = new CustomEvent("changeTime", f),
                                    s = new CustomEvent(
                                        "change",
                                        Object.assign(f, {
                                            detail: "timepicker",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            for (
                                ...
                                switch (
                                    (a = this.settings.timeFormat.charAt(u))
                                ) {
                                    case "a":
                                        l +=
                                            r.getHours() > 11
                                    ...
                                    case "\\":
                                        u++,
                                            (l +=
                                                this.settings.timeFormat.charAt(
                                                    u
                                                ));
                                        break;
                                    default:
                        ...
                        var d = c,
                            ...
                            p =
                                d % o < 43200
                                    ? "ui-timepicker-am"
                                    : "ui-timepicker-pm",
                            h = { label: f, value: u(d, n), className: p };
                        if (
                            (null !== n.minTime() ||
                                null !== n.durationTime()) &&
                            n.showDuration
                            ...
                            var g,
                                v =
                                    ...
                                    void 0 !== g
                                        ...
                                        : n.minTime();
                            v > c && (v -= o);
                            var y = e._int2duration(c - v, n.step());
                            h.duration = y;
                        }
                        var b,
        ...
        (c = function (t) {
                        ...
                        if (
                            ...
                            if (!u.length) {
                                ...
                                null !== c
                                    ? (u = t(s._findRow(c)))
                                    : a.scrollDefault() &&
                                      (u = t(s._findRow(a.scrollDefault())));
                            }
                            if (
                                ((u.length &&
            ...
            function n(e) {
                ...
                if (
                    ...
                    e.val() &&
                        r.val(n._roundAndFormatTime(n.anytime2int(e.val()))),
                        r.on("focus", function () {
                            t(this)
