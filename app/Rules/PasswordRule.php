    ...
    public function passes($attribute, $value)
    {
        ...
        $validator = Validator::make(
            ...
            if ($this->mixedCase && !preg_match('/(\p{Ll}+.*\p{Lu})|(\p{Lu}+.*\p{Ll})/u', $value)) {
                $validator->errors()->add($attribute, ':attribute harus mengandung setidaknya satu huruf kapital dan satu huruf kecil.');
            }

            if ($this->letters && !preg_match('/\pL/u', $value)) {
                $validator->errors()->add($attribute, ':attribute harus mengandung setidaknya satu huruf.');
            }

            if ($this->symbols && !preg_match('/\p{Z}|\p{S}|\p{P}/u', $value)) {
                $validator->errors()->add($attribute, ':attribute harus mengandung setidaknya satu simbol.');
            }
